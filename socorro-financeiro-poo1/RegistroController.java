...
public class RegistroController implements Initializable, ControlledScreen {
    ...
    public void salvarCampos() {
        if ( usuarioReg.getText().equals("") && senhaReg.getText().equals("") && confirmarReg.getText().equals("") ) {
                    campoRegistro.setText("Os campos estão vazios!");
                }
                else if( senhaReg.getText().equals("") ){
                    campoRegistro.setText("Campo senha vazio!");
                    limparCampos(1);
                } 
                     else if ( usuarioReg.getText().equals("") ){
                         campoRegistro.setText("Campo usuário vazio!");
                         limparCampos(1);
                     }
                         else if( confirmarReg.getText().equals("") ){
                              campoRegistro.setText("Campo confirmar senha vazio!");
                              limparCampos(1);
                         }
                                else {
    ...
    public void salvarArquivo() {
        ...
        try {
            ...
            campoRegistro.setText("Erro ao salvar banco de usuários !");
            System.out.println("Erro ao salvar banco de usuários !");
            ex.printStackTrace();
        }
    }
