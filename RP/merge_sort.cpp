...
vector<int> mergin_sort(vector<int>);
...
vector<int> mergin_sort(vector<int> a){
    if(a.size()==1)
        return a;
    int offset = a.size()/2;
    vector<int> b = mergin_sort(vector<int>(a.begin(),a.begin()+offset ));
                                                //novo vetor começo e fim
    vector<int> c = mergin_sort(vector<int>(a.begin()+offset,a.end()));
                                                //novo vetor começo e fim
    return mergin(b,c);
}
